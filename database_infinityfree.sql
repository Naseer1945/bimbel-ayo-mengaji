-- ============================================================
-- database_infinityfree.sql — versi untuk import di InfinityFree
-- Cara pakai: Client Area -> MySQL Databases -> Admin (phpMyAdmin)
--   -> pilih database if0_42396638_bimbel_ayo_mengaji
--   -> tab Import -> pilih file ini -> Go
-- (Tanpa CREATE DATABASE/USE karena tidak diizinkan di shared hosting)
-- ============================================================
-- ============================================================
